...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <ExportReviewDialog
        plan={exportReviewPlan}
        dialogRef={exportReviewDialogRef}
        closeButtonRef={exportReviewCloseRef}
        onClose={closeExportReview}
        onConfirm={confirmExportReview}
        onDialogKeyDown={handleExportReviewDialogKeyDown}
      />

      <ShortcutsDialog
        open={shortcutsOpen}
        dialogRef={shortcutDialogRef}
        closeButtonRef={shortcutCloseRef}
        onClose={closeKeyboardShortcuts}
        onDialogKeyDown={handleShortcutDialogKeyDown}
      />

      <ConsoleHelpDialog
        open={consoleHelpOpen}
        dialogRef={consoleHelpDialogRef}
        closeButtonRef={consoleHelpCloseRef}
        onClose={closeConsoleHelp}
        onDialogKeyDown={handleConsoleHelpDialogKeyDown}
        onCopyDiagnostics={copyConsoleDiagnostics}
        onExportSettings={exportGuiSettings}
        onClearSettings={clearGuiSettingsWithConfirm}
      />
    </div>
  );
}
